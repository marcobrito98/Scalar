...
int BBHSF_Index (int ivar, int i, int j, int k, int nvar, int n1, int n2, int n3);
...
void BBHSF_F_of_v (CCTK_POINTER_TO_CONST cctkGH,
...
void BBHSF_JFD_times_dv (int i, int j, int k, int nvar, int n1,
		   int n2, int n3, derivs dv, derivs u, CCTK_REAL *values);
void BBHSF_SetMatrix_JFD (int nvar, int n1, int n2, int n3,
		    derivs u, int *ncols, int **cols, CCTK_REAL **Matrix);
CCTK_REAL BBHSF_PunctEvalAtArbitPosition (CCTK_REAL *v, int ivar, CCTK_REAL A, CCTK_REAL B, CCTK_REAL phi,
...
CCTK_REAL BBHSF_PunctIntPolAtArbitPosition (int ivar, int nvar, int n1,
				   int n2, int n3, derivs v, CCTK_REAL x,
				   CCTK_REAL y, CCTK_REAL z);
...
void BBHSF_C_To_c (int nvar, CCTK_REAL X, CCTK_REAL R, CCTK_REAL *x,
	     CCTK_REAL *r, derivs U);
void BBHSF_rx3_To_xyz (int nvar, CCTK_REAL x, CCTK_REAL r, CCTK_REAL phi, CCTK_REAL *y,
		 CCTK_REAL *z, derivs U);

/* Routines in  "Equations.c"*/
CCTK_REAL BBHSF_BY_KKofxyz (CCTK_REAL x, CCTK_REAL y, CCTK_REAL z);
void BBHSF_BY_Aijofxyz (CCTK_REAL x, CCTK_REAL y, CCTK_REAL z, CCTK_REAL Aij[3][3]);
void BBHSF_NonLinEquations (CCTK_REAL rho_adm,
...
void BBHSF_TestRelax (CCTK_POINTER_TO_CONST cctkGH,
                int nvar, int n1, int n2, int n3, derivs v, CCTK_REAL *dv);
void BBHSF_Newton (CCTK_POINTER_TO_CONST cctkGH,
             int nvar, int n1, int n2, int n3, derivs v,
	           CCTK_REAL tol, int itmax);

/* Routines in "SF_density.c"*/
void SF_Initialize(CCTK_REAL x, CCTK_REAL y, CCTK_REAL z, CCTK_REAL *phi_re, CCTK_REAL *phi_im);
