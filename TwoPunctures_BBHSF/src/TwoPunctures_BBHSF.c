  ...
  if (do_initial_debug_output && CCTK_MyProc(cctkGH) == 0)
  {
    ...
    for (ivar = 0; ivar < nvar; ivar++)
      for (i = 0; i < n1; i++)
        ...
        /* Calculation of (y,z)*/
        BBHSF_rx3_To_xyz (nvar, s_x[i3D], r, phi, &(s_y[indx]), &(s_z[indx]), U);
        fprintf(debug_file,
    ...
    for (i=n2-10; i<n2; i++)
    {
      ...
      d = BBHSF_PunctIntPolAtArbitPosition(0, nvar, n1, n2, n3, v,
              s_x[indx], 0.0, 0.0);
...
void 
TwoPunctures_BBHSF (CCTK_ARGUMENTS)
{
  ...
  * mm = par_m_minus;
  ...
  if (! F) {
    ...
    *mm_adm = (1 + um) * *mm + *mp * *mm / (4. * par_b);
    ...
    admMass = (*mp + *mm
               - 4*par_b*BBHSF_PunctEvalAtArbitPosition(v.d0, 0, 1, 0, 0, nvar, n1, n2, n3));
  ...
  for (int k = imin[2]; k < imax[2]; ++k)
  {
	...
	/*==========================================================================*/
        ...
        case GSM_Taylor_expansion:
          U = BBHSF_PunctTaylorExpandAtArbitPosition
