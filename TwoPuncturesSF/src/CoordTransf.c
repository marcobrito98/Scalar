/* TwoPuncturesSF:  File  "CoordTransf.c"*/
...
/*-----------------------------------------------------------*/
void
AB_To_XRSF (int nvar, CCTK_REAL A, CCTK_REAL B, CCTK_REAL *X, CCTK_REAL *R,
	  derivs U)
...
/*-----------------------------------------------------------*/
void
C_To_cSF (int nvar, CCTK_REAL X, CCTK_REAL R, CCTK_REAL *x, CCTK_REAL *r,
	derivs U)
...
/*-----------------------------------------------------------*/
void
rx3_To_xyzSF (int nvar, CCTK_REAL x, CCTK_REAL r, CCTK_REAL phi,
