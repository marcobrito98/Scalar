...
extern "C"
void TwoPunctures_MetadataSF (CCTK_ARGUMENTS)
{
  ...
  {
    ofstream o;
    o.open(string(string(out_dir) + "/TwoPuncturesSF.bbh").c_str());
...
# TwoPuncturesSF thorn.  The format is described in the NR Data Format Document\n\
